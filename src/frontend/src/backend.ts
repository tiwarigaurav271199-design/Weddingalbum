...
import type { UserProfile as _UserProfile, UserRole as _UserRole, WeddingInfo as _WeddingInfo, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPhotoToAlbum(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPhotoToAlbum(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createAlbum(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deletePhotoFromAlbum(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAlbums(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async getPhotosInAlbum(arg0: string): Promise<Array<Photo>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPhotosInAlbum(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWeddingInfo(): Promise<WeddingInfo | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getWeddingInfo();
    ...
    async updateWeddingInfo(arg0: WeddingInfo): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateWeddingInfo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_WeddingInfo]): WeddingInfo | null {
    return value.length === 0 ? null : value[0];
}
